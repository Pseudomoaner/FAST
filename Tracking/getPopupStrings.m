function [stringArrayX,stringArrayY] = getPopupStrings(trackSettings)
%GETPOPUPSTRINGS generates the strings that should be available in the
...
%       selection panel) from the diffusionTracker GUI.
%   
%   OUTPUTS:
