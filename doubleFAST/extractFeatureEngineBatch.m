...
%EXTRACTFEATUREENGINEBATCH extracts feature information from a given input
%dataset based on the settings specified during an initial run through the
%FAST GUI.
%
%   INPUTS:
%       -root: String defining the location of the target root
%       directory.
%       -featSettings: Setting structure generated by the FAST GUI's
%       feature extraction module. Can typically be found within the
%       'CellFeatures.mat' file of an analysed dataset.
%
