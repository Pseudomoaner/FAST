...
for i = 1:length(inField.nCells) %The index of the cell alpha.
    ...
    if strcmp(inField.boundConds,'none')
        [dUdx,dUdy,dUdz,dUdthet,dUdphi] = baseCalcEnergyGradients(xBets,yBets,zBets,lBets,nBets,thetBets,phiBets,xAlph,yAlph,zAlph,lAlph,nAlph,thetAlph,phiAlph,U0,lam);
    elseif strcmp(inField.boundConds,'periodic')
        [dUdx,dUdy,dUdz,dUdthet,dUdphi] = baseCalcEnergyGradientsPeriodic(xBets,yBets,zBets,lBets,nBets,thetBets,phiBets,xAlph,yAlph,zAlph,lAlph,nAlph,thetAlph,phiAlph,U0,lam,boundX,boundY,Width,Height);
    end
